  ...
  return (
    <footer id="resources" className="border-t bg-neutral-50/50">
      ...
      <div className="border-t py-6 text-center text-xs text-neutral-500">
        © {new Date().getFullYear()} Xbloc². All rights reserved. Information on this website is provided as general guidance only and does not constitute a recommendation to use any of our products. You should always seek professional advice to confirm that Xbloc2 products and their intended applications meet your specific requirements. While product images and colors are shown as accurately as possible, we recommend reviewing physical samples prior to purchase since digital representations may affect appearance. Additionally, variations in color and surface finish may occur between batches due to standard manufacturing processes and raw materials. For further information, please contact Xbloc2 at 888-123-4567.
      </div>
    </footer>
  );
}
